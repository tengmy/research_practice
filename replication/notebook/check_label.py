...
# print(type(y_class))
# y_class.to_csv('./images/true_class.txt', sep='\t', index=False)

# Get predictions for validation data
pred_prob = model.predict_generator(validation_generator, verbose=0)
#print(type(pred_prob))
#np.savetxt("./images/pred_prob.txt", pred_prob, fmt="%d")

pred_class = np.argmax(pred_prob, -1)
#np.savetxt("./images/pred_class.txt", pred_class, fmt="%d")
...
# plt.savefig("images/confusion_matrix_cm.png");
# plt.clf();
...
# plt.xlabel('Predicted class')
# plt.yticks(rotation=0)
# plt.savefig("images/confusion_matrix_std.png");
# plt.clf();
...
# with open('./images/df.txt', 'w') as f:
#     df.to_csv('./images/df.txt', sep='\t', index=False)
#     f.close()
...
# plt.savefig("./images/incorrect.png");
# plt.clf();

# # In[ ]:


# # True examples of correctly classified class
# idx = 31
...
# plt.subplots_adjust(top=0.92);\
# plt.savefig("./images/correct.png");
# plt.clf();
